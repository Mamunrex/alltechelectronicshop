<div class="container mycss">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 paddintop2">
		
			<div class="thumbnail">
							
				<img src="${images}/${product.code}.jpg" class="img img-responsive image-border"/>
		...
		<div class="col-xs-12 col-sm-6 paddintop3">
			...
			<c:choose>
				...
				<c:when test="${product.quantity < 1}">
					...
					<i class="fa fa-cart-plus" aria-hidden="true"></i>&#160; Add to Cart</strike></a>
